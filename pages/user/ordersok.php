...
<body>
    <div class="orders-section container">
        ...
        <div class="filter-section" id="filterSection">
            <button class="filter-btn <?php echo $currentFilter === 'all' ? 'active' : ''; ?>" data-status="all">All Orders</button>
            <button class="filter-btn <?php echo $currentFilter === 'pending' ? 'active' : ''; ?>" data-status="pending">Pending</button>
            <button class="filter-btn <?php echo $currentFilter === 'shipped' ? 'active' : ''; ?>" data-status="shipped">Shipped</button>
            <button class="filter-btn <?php echo $currentFilter === 'delivered' ? 'active' : ''; ?>" data-status="delivered">Delivered</button>
            <button class="filter-btn <?php echo $currentFilter === 'cancelled' ? 'active' : ''; ?>" data-status="cancelled">Cancelled</button>
        </div>

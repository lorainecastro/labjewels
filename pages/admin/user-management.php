                ...
                <tbody id="userTableBody">
                    ...
                    if (!empty($users)) {
                        foreach ($users as $user) {
                            ...
                            echo "<td><img src='../../assets/image/profile/" . htmlspecialchars($user['icon'] ?: 'no-icon.png') . "' alt='User Icon' style='width: 45px; height: 45px; border-radius: 50%; object-fit: cover;'></td>";
                            echo "<td>$status</td>";
